...
import { Flame, Award, Download, CheckCircle, Sparkles, EyeOff, ShieldAlert, Globe, Megaphone, Home } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#E0E0E0] shadow-xs pt-safe">
      <div className="max-w-md mx-auto px-3 sm:px-4 py-2 flex items-center justify-between gap-1.5">
        {/* Logo & Brand */}
